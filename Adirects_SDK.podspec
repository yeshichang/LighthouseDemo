#
#  Be sure to run `pod spec lint Adirects_SDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC Adirects_SDK DESC

  s.homepage     = "https://github.com/yeshichang/LighthouseDemo"
  ...
  s.source       = { :git => "https://github.com/yeshichang/LighthouseDemo.git", :tag => "0.0.1" }
